...
def bouw_research_data(rapport):
    """Bouwt de research data structuur op."""
    video_format_regels = {
...
def sla_research_op_tabel(tabel, filter, rapport):
    """Slaat research rapport op in opgegeven tabel (producten of projecten)."""
    print(f"[Agent 2] Research opslaan in {tabel}...")
    data   = bouw_research_data(rapport)
