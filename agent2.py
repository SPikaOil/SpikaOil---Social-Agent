...
def run(product_id=None, product_naam=None):
    """Voert Agent 2 uit voor een specifiek product."""
    import urllib.parse
    ...
    # Check of research al gedaan is
    if product.get("research_gedaan"):
        print(f"[Agent 2] Research al gedaan voor {product.get('product_naam')} — overslaan")
        print("[Agent 2] Gebruik --force om opnieuw te draaien")
        return {"success": True, "bericht": "Research al beschikbaar", "product_id": pid}
